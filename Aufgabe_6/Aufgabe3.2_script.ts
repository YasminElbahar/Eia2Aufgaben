namespace Haushaltshilfe {
    ...
    async function handleLoad(_event: Event): Promise<void> {
        ...
        let submit: HTMLButtonElement = <HTMLButtonElement>document.querySelector("button[type=reset]");
    ...
    async function sendOrder(_event: Event): void {
        ...
        let response: Response = await fetch("Aufgabe3.2.html?" + query.toString());
